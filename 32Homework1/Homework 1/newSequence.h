...
public:
    ...
    Sequence(int size = DEFAULT_MAX_ITEMS); // Create a sequence (i.e., one whose size() is size).
    
    Sequence(const Sequence& other); // Copy Constructor for Sequence
    
    Sequence& operator=(const Sequence& other); // Assignement Operator for Sequence
